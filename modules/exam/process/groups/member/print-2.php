...
$params = " WHERE exam_group_member.group_id IN (3,4,11,12)";
...
foreach($member as $m)
{
    ...
    $query .= "UPDATE users SET password = '$pass' WHERE id = $m->user_id;";
...
return view('exam/views/groups/member/print-2', compact('member', 'passwords'));